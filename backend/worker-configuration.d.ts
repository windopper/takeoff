/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 00cf87d47eb8f37248fa044513945266)
// Runtime types generated with workerd@1.20250617.0 2025-06-18 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GEMINI_API_KEY: string;
		CLAUDE_API_KEY: string;
		PAPERSWITHCODE_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_KEY" | "CLAUDE_API_KEY" | "PAPERSWITHCODE_API_KEY" | "TAKEOFF_API_KEY">> {}
}
